...
// lay data vao combobox khach hang	
...
// tim kiem khach hang
//	public void timKiemKhachHang() {
////		cmbKhachHang.showPopup();
////		
////		cmbModel_KH = (DefaultComboBoxModel) cmbKhachHang.getModel();
////		cmbModel_KH.removeAllElements();
//		
//		List<KhachHang> listKH = khdao.timKiemTheoSdt(txtTimKhachHang);
//		int row = listKH.size();
//		if (row > 0) {
//			for (int i = 0; i < row; i++) {
//
...
//
//				MyCombobox cmbkh = new MyCombobox(makh, tenkh);
//				cmbModel_KH.addElement(cmbkh);
//			}
//		}
//
//	}
